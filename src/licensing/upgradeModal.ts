...
export class UpgradeModalPanel {
   ...
   */
  public static show(context: vscode.ExtensionContext, nearAccountId: string): void {
  ...
  private async handleStripeCheckout(): Promise<void> {
    ...
    try {
      ...
      const response = await fetch(`${apiUrl}/api/checkout`, {
        ...
        body: JSON.stringify({
          near_account_id: this.nearAccountId,
        }),
      });
...
<body>
  ...
  <div class="container">
    ...
    <div class="account-info">
      Licensing for: <strong>${this.nearAccountId}</strong>
    </div>
